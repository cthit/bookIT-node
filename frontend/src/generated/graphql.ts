...
export type InputEvent = {
  ...
  room: Array<Room | null | undefined>;
...
export type BookingFragment = { id: string | null, title: string, description: string | null, start: string, end: string, room: Array<Room>, phone: string, booked_as: string, booked_by: string, created_at: string | null, updated_at: string | null };
...
export type CalendarQuery = { eventsFT: Array<{ id: string | null, title: string, description: string | null, start: string, end: string, room: Array<Room>, phone: string, booked_as: string, booked_by: string, created_at: string | null, updated_at: string | null } | null> | null, illegalSlots: Array<{ start: string, end: string, title: string, description: string | null, room: Array<Room> }> | null };
...
export type BookingDetailQuery = { event: { id: string | null, title: string, description: string | null, start: string, end: string, room: Array<Room>, phone: string, booked_as: string, booked_by: string, created_at: string | null, updated_at: string | null } | null };
...
export type MoveBookingMutationVariables = Exact<{
  id: string;
  start: string;
  end: string;
...
export type MoveBookingMutation = { moveEvent: { en: string, sv: string } | null };
...
export type DeleteRuleMutation = { deleteRule: boolean | null };
...
export const MoveBookingDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"MoveBooking"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"start"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"end"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"previousStart"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"previousEnd"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"moveEvent"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}},{"kind":"Argument","name":{"kind":"Name","value":"start"},"value":{"kind":"Variable","name":{"kind":"Name","value":"start"}}},{"kind":"Argument","name":{"kind":"Name","value":"end"},"value":{"kind":"Variable","name":{"kind":"Name","value":"end"}}},{"kind":"Argument","name":{"kind":"Name","value":"previousStart"},"value":{"kind":"Variable","name":{"kind":"Name","value":"previousStart"}}},{"kind":"Argument","name":{"kind":"Name","value":"previousEnd"},"value":{"kind":"Variable","name":{"kind":"Name","value":"previousEnd"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"en"}},{"kind":"Field","name":{"kind":"Name","value":"sv"}}]}}]}}]} as unknown as DocumentNode<MoveBookingMutation, MoveBookingMutationVariables>;
