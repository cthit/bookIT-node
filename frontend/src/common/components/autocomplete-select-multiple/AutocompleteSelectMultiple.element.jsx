...
const AutocompleteSelectMultiple = ({
  ...
  return (
    <Autocomplete
        ...
        onChange({
          target: {
            value: newValue.map(option =>
              Object.prototype.toString.call(option) === "[object String]" ? option : option.value,
            ),
          },
        });
      }}
      ...
      options={options}
      noOptionsText={noOptionsText == null ? text.NoOptions : noOptionsText}
      onBlur={onBlur}
      multiple
      disabled={disabled}
        ...
        return (
          <>
            <Checkbox
              ...
              style={{ marginRight: 8 }}
              checked={selected}
              color={checkboxPrimary ? "primary" : checkboxSecondary ? "secondary" : "default"}
            />
            {option.text}
          </>
        );
...
AutocompleteSelectMultiple.defaultProps = {
  options: [],
  value: [],
  onChange: () => {},
  noOptionsText: null,
